...
public class RVMWebSocket extends NanoWSD.WebSocket {
    ...
    protected void onMessage(NanoWSD.WebSocketFrame message) {
        String messageString = message.getTextPayload();
        BaseMessage baseMessage = SimpleGson.getInstance().fromJson(messageString, BaseMessage.class);
        switch (baseMessage.op) {
            case "": {
