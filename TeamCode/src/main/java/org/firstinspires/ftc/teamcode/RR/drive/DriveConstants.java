...
public class DriveConstants {
    ...
    public static double TRACK_WIDTH = 12; //10.40 ; // in
    ...
    public static double MAX_ANG_VEL = 6; // Math.toRadians(90);
    public static double MAX_ANG_ACCEL = 6; //Math.toRadians(90);
